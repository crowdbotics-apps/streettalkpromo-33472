...
## Project Structure
    ...
    ├── streettalkpromo_33472  # Django project configurations
...
1. Clone this repo and `cd streettalkpromo_33472`
...
2. Clone this repo and `cd streettalkpromo_33472`
